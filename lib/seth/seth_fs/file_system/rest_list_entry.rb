  ...
  module SethFS
    module FileSystem
      class RestListEntry < BaseFSObject
        ...
        def read
          Seth::JSONCompat.to_json_pretty(_read_hash)
        end
        ...
        def seth_object
          # REST will inflate the Seth object using json_class
        ...
        def compare_to(other)
          ...
          value_json = Seth::JSONCompat.to_json_pretty(value)
          begin
            other_value = JSON.parse(other_value_json, :create_additions => false)
          rescue JSON::ParserError => e
            Seth::Log.warn("Parse error reading #{other.path_for_printing} as JSON: #{e}")
            return [ nil, value_json, other_value_json ]
          end
          other_value = minimize_value(other_value)
          other_value_json = Seth::JSONCompat.to_json_pretty(other_value)
