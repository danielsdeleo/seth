...
We are glad you want to contribute to Seth!

We utilize **Github Issues** for issue tracking and contributions. You can contribute in two ways:

1. Reporting an issue or making a feature request [here](#issues).
2. Adding features or fixing bugs yourself and contributing your code to Seth.
...
1. **Tests:** To ensure high quality code and protect against future regressions, we require all the
  code in Seth to have at least unit test coverage. See the [spec/unit](https://github.com/opscode/seth/tree/master/spec/unit)
...
In addition to this it would be nice to include the description of the problem you are solving
  with your change. You can use [Seth Issue Template](#issuetemplate) in the description section
  of the pull request.

### <a name="cr"></a> Seth Code Review Process

The Seth Code Review process happens on Github pull requests. See
...
If you would like to learn about when your code will be available in a release of Seth, read more about
  [Seth Release Process](#release).

### Contributor License Agreement (CLA)
Licensing is very important to open source projects. It helps ensure the
  software continues to be available under the terms that the author desired.

Seth uses [the Apache 2.0 license](https://github.com/opscode/seth/blob/master/LICENSE)
...
To make a good faith effort to ensure these criteria are met, Seth requires an Individual CLA
...
## <a name="issues"></a> Seth Issue Tracking

Seth Issue Tracking is handled using Github Issues.

If you are familiar with Seth and know the component that is causing you a problem or if you
...
Otherwise you can file your issue in the [Seth project](https://github.com/opscode/seth/issues)
...
## <a name="release"></a> Seth Release Cycles

Our primary shipping vehicle is operating system specific packages that includes
  all the requirements of Seth. We call these [Omnibus packages](https://github.com/opscode/omnibus-ruby)

We also release our software as gems to [Rubygems](http://rubygems.org/) but we strongly
  recommend using Seth packages since they are the only combination of native libraries &
  gems required by Seth that we test throughly.
...
Announcements of releases are available on [Seth Blog](http://www.getseth.com/blog) when they are
  available.
...
* [Seth Docs](http://docs.opscode.com/)
* [Learn Seth](https://learnseth.opscode.com/)
* [Seth Inc](http://www.getseth.com/)
